...
public abstract class AbstractMockitoVerification<M, P> implements MockitoVerification<P> {
   ...
   *          {@link org.finos.fluxnova.bpm.engine.delegate.JavaDelegate},
   *          {@link org.finos.fluxnova.bpm.engine.delegate.TaskListener} or
   *          {@link org.finos.fluxnova.bpm.engine.delegate.ExecutionListener}.
   * @param parameterType
   *          the parameter the main method (execute() or notify() expects, one
   *          of either
   *          {@link org.finos.fluxnova.bpm.engine.delegate.DelegateExecution} or
   *          {@link org.finos.fluxnova.bpm.engine.delegate.DelegateTask}.
   */
   ...
   *          {@link VerificationMode} can be used.
   * @throws Exception

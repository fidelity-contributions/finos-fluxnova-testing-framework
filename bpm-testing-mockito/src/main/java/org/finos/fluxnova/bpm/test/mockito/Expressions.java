...
import static org.finos.fluxnova.bpm.test.mockito.function.CreateInstance.mockInstance;
import static org.finos.fluxnova.bpm.test.mockito.function.CreateInstance.newInstanceByDefaultConstructor;
import static org.finos.fluxnova.bpm.test.mockito.function.NameForType.juelNameFor;

/**
 * Util class that delegates to
 * {@link Mocks#register(String, Object)} and
 * {@link Mocks#get(Object)} in a type-safe
 * way.
 * <p/>

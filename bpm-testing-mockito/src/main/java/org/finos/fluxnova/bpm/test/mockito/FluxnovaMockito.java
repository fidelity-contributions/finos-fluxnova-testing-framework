...
import org.finos.fluxnova.bpm.test.mockito.delegate.*;
import org.finos.fluxnova.bpm.test.mockito.function.NameForType;
...
import org.finos.fluxnova.bpm.test.mockito.service.RuntimeServiceFluentMock;
...
public enum FluxnovaMockito {
   ...
   * @see #verifyJavaDelegateMock(org.finos.fluxnova.bpm.test.mockito.mock.FluentJavaDelegateMock)
   */
  ...
  /**
   * Registers mocks via
   * {@link Mocks#register(String, Object)} for
   ...
   * @see #registerMockInstances(Collection)
   */
  ...
  /**
   * Delegates to
   * {@link Mocks#register(String, Object)}
   *

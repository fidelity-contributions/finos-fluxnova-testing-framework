...
import org.finos.fluxnova.bpm.engine.delegate.*;
import org.finos.fluxnova.bpm.test.mockito.function.ParseDelegateExpressions;
import org.finos.fluxnova.bpm.test.mockito.mock.FluentExecutionListenerMock;
import org.finos.fluxnova.bpm.test.mockito.mock.FluentJavaDelegateMock;
import org.finos.fluxnova.bpm.test.mockito.mock.FluentTaskListenerMock;
import org.finos.fluxnova.bpm.test.mockito.verify.ExecutionListenerVerification;
import org.finos.fluxnova.bpm.test.mockito.verify.JavaDelegateVerification;
import org.finos.fluxnova.bpm.test.mockito.verify.MockitoVerification;
import org.finos.fluxnova.bpm.test.mockito.verify.TaskListenerVerification;

import jakarta.annotation.Nonnull;
import java.net.URL;

import static org.finos.fluxnova.bpm.test.mockito.Expressions.getRegistered;
import static org.finos.fluxnova.bpm.test.mockito.Expressions.registerInstance;
...
public enum DelegateExpressions {
   ...
   * @see org.finos.fluxnova.bpm.test.mockito.Expressions#registerInstance(String,
   * Object)
   */
   ...
   * @see org.finos.fluxnova.bpm.test.mockito.Expressions#getRegistered(String)
   */

...
interface GlobalVariableWriter<S : GlobalVariableWriter<S>> {
     ...
     * @see [org.finos.fluxnova.bpm.test.data.adapter.WriteAdapter.set]
    </T> */
     ...
     * @param <T>             type of value
     * @return current writer instance
     * @see [org.finos.fluxnova.bpm.test.data.adapter.WriteAdapter.setLocal]
    </T> */
     ...
     * @param <T>             type of value
     * @return current writer instance
     * @see [org.finos.fluxnova.bpm.test.data.adapter.WriteAdapter.remove]
    </T> */

...
import org.finos.fluxnova.bpm.test.data.guard.condition.matches
...
class AntiCorruptionLayerTest {
  ...
  val MY_ACL = FluxnovaBpmDataACL.guardTransformingLocalReplace(
    TRANSIENT.name,
  ...
  val MY_ACL2 = FluxnovaBpmDataACL.guardTransformingLocalReplace(
    TRANSIENT.name,

...
import static org.finos.fluxnova.bpm.test.data.FluxnovaBpmData.*;
import org.finos.fluxnova.bpm.test.data.factory.*;
import org.finos.fluxnova.bpm.test.data.reader.*;
import org.finos.fluxnova.bpm.test.data.writer.*;
...
public class FluxnovaBpmDataTest {

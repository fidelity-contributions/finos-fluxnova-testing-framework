...
class AccountOpeningScriptsTest extends ScriptTestSpecification {
    ...
    def 'validate_input_data_first_review'() {
        ...
        when:
            executeInlineScript('Task_ValidateInitialData', 'AccountOpening-InvestmentAccount.bpmn')
        then:
    ...
    def 'checkAssetValue_standardAccount'() {
        setup:
            ...
            mockExecutionGetVariable(variables)
        when:
            executeInlineScript('Task_CheckAssetValue', 'AccountOpening-InvestmentAccount.bpmn')
        then:
    ...
    def 'logManagerRejection'() {
        ...
        setup:
            ...
            mockExecutionGetVariable(variables)
        when:
            executeInlineScript('Task_LogRejection', 'AccountOpening-InvestmentAccount.bpmn')
        then:
    ...
    def 'logAccountCreation_Phone_WithoutPrefix'() {
        ...
        setup:
            ...
            mockExecutionGetVariable(variables)
        when:
            executeInlineScript('Task_LogAccountCreation', 'AccountOpening-InvestmentAccount.bpmn')
        then:
    ...
    def 'accountCreateFailedError'() {
        setup:
            ...
            mockExecutionGetVariable(variables)
        when:
            executeInlineScript('Task_HandleAccountError', 'AccountOpening-InvestmentAccount.bpmn')
        then:
    ...
    def 'logSMSError'() {
        setup:
            ...
            mockExecutionGetVariable(variables)
        when:
            executeInlineScript('Task_LogSMSError', 'AccountOpening-InvestmentAccount.bpmn')
        then:
